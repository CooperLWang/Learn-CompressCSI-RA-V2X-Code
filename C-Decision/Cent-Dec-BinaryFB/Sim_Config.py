# set the key parameters for the C-Decision scheme with Binary Feedback
import datetime  # show the date and current time


class RL_Config:
    """
    Define the RL_Config class
    """
    def __init__(self):
    ...
    def set_robust_test_values(self, num_test_episodes, num_test_steps, opt_flag, v2v_weight, v2i_weight,
                               feedback_interval, input_noise_level, feedback_noise_level):
        # set the key values for robust testing
        self.Num_Run_Episodes = num_test_episodes
        self.Num_Test_Steps = num_test_steps
        self.Opt_Flag = opt_flag
        self.v2v_weight = v2v_weight
