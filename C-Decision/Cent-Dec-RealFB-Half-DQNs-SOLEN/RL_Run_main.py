...
def run_test(curr_RL_Config, BS_Agent, test_seed_sequence):
    ...
    if Opt_Flag:
        ...
        ave_SOLEN_Return = np.sum(SOLEN_Expect_Return) / Num_Run_Episodes
        print('      The average return of SOLEN scheme is ', ave_SOLEN_Return)
        ...
        ave_RA_Per_V2V_Rate = np.sum(RA_Per_V2V_Rate) / Num_Run_Episodes
        print('      The average V2V rate per episode of RA scheme is ', ave_RA_Per_V2V_Rate)
        ave_SOLEN_Per_V2V_Rate = np.sum(SOLEN_Per_V2V_Rate) / Num_Run_Episodes
        print('      The average V2V rate per episode of SOLEN scheme is ', ave_SOLEN_Per_V2V_Rate)
        ...
        ave_SOLEN_Per_V2I_Rate = np.sum(SOLEN_Per_V2I_Rate) / Num_Run_Episodes
        print('      The average V2I rate of SOLEN scheme is ', ave_SOLEN_Per_V2I_Rate)
        ...
        SOLEN_ave_Per_V2B_Interference = np.sum(SOLEN_Per_V2B_Interference) / Interfernece_Normalizer
        print('      The average V2B interference of SOLEN scheme is ', SOLEN_ave_Per_V2B_Interference)
        ...
        pickle.dump((ave_Expected_Return, ave_Per_V2I_Rate,
                     ...
                     ave_RA_Return, ave_RA_Per_V2I_Rate,
                     RA_ave_Per_V2B_Interference, ave_RA_Per_V2V_Rate,
                     ave_SOLEN_Return, ave_SOLEN_Per_V2I_Rate,
                     SOLEN_ave_Per_V2B_Interference, ave_SOLEN_Per_V2V_Rate,
                     BetterThanRA_Num, LessThanRA, LessThanRA_Index), file_to_open)
        file_to_open.close()
