...
class BS:
    ...
    def _create_model(self):
        ...
        Num_Compress_NN_Inner_Layer1 = 8
        Num_Compress_NN_Inner_Layer2 = 16
        Num_Compress_NN_Inner_Layer3 = 8
        ...
        BS_Dense1 = Dense(250, activation='relu', name='BS_Dense1')(BS_Input)
        BS_Dense2 = Dense(200, activation='relu', name='BS_Dense2')(BS_Dense1)
        BS = Dense(150, activation='relu', name='BS')(BS_Dense2)
        ...
        Num_DQN_Inner_Layer1 = 40
        Num_DQN_Inner_Layer2 = 20
        Num_DQN_Inner_Layer3 = 10
